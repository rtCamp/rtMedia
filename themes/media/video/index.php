...
<div id="content">
    <div class="padder">
        <div id="rt-header">
                ...
                <span id ="rt-video-dir">Video Directory </span>
        ...
        <div class="item-list-tabs rt-item-list-tabs">
                <ul>
                        <?php do_action( 'bp_before_media_type_tab_videos' ) ?>
                    <li id="media-photo" class="selected"><a href="<?php echo bp_get_root_domain() . '/' . BP_MEDIA_SLUG . '/photo/' ?>"><?php printf( __( 'Videos Directory', 'buddypress' )) ?></a></li>
