...
//                 alert(response);
                ...
                jQuery(".thanks").prepend('<img src="'+url+'"/images/loading_wheel.gif" />');
                var data = {
                    ...
                    user_id:jQuery('#current-user-id').val()
                     ...
                     jQuery.post(ajaxurl, data, function(response) {
                     jQuery('.thanks').find('img').replaceWith(response);
                });
                timesClicked++;
                if (timesClicked >= 1) {
...
//http://localhost.localdomain/bp-local
     ...
     jQuery('#no').click(function(){
                    var url = jQuery('#url').val();
                    jQuery(".thanks").append('<img src="<?php echo WP_PLUGIN_URL; ?>/buddypress-media/themes/media/images/ajax-loader.gif" />');
                    var data ={action:'media_delete_local', media_id:jQuery('#current-media-id').val()};
                     jQuery.post(ajaxurl, data, function(response) {
//                   alert(response);
                    jQuery(".thanks").remove('img');
