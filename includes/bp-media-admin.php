	...
	if(isset($_POST['submit'])){
        ...
        if( empty( $bp_media_errors ) ){
            ...
            if($request_type == 'bug_report'){
                ...
                $server_data = bp_media_get_server_info();                 
                $server_info = '';
...
add_action('wp_ajax_bp_media_request_type', 'bp_media_handle_request_type');
function bp_media_handle_request_type(){
    $request_type = $_REQUEST['request_type'];
        bp_media_bug_report_form($request_type);
        die();
}

add_action('wp_ajax_bp_media_cancel_request', 'bp_media_cancel_request');
...
function bp_media_bug_report_form( $request_type ){
    global $current_user; ?>
    <div class="postbox " id="bp_media_bug_report_metabox"><?php 
        ...
        <div title="Click to toggle" class="handlediv"><br></div><h3 class="hndle"><span><?php echo $meta_title; ?></span></h3>
        <div class="inside">
            <div id="support-form" class="bp-media-form">               
                <ul>
                <li>
...
<!--                        <li>
                            <label class="template_select_label bp-media-label" for="support_template">Theme templates:</label>
                            <div class="template_select_container">
                                <select id="support_template" name="ur_templates[]" multiple="multiple" size="10" style="height: auto;">
    ...
    if( $request_type == 'bug_report' ){  ?>   
        <div class="postbox " id="bp_media_bug_report_metabox">
            <div title="Click to toggle" class="handlediv"><br></div><h3 class="hndle"><span>Additional Information</span></h3>
            <div class="inside">
                <div id="support-form" class="bp-media-form">  
                    <ul>
    ...
    <p class="form-footer">
        ...
        <input type="submit" value="Cancel" name="cancel_request" class="button-primary cancel_request" id="cancel_request" />
    </p><?php     
}
