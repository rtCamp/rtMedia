...
jQuery.fn.pagination = function(maxentries, opts){
    opts = jQuery.extend({
        ...
        num_edge_entries:0,
        link_to:"#",
        prev_text:"Prev Photo",
        next_text:"Next Photo",
        ellipse_text:"...",
...
function pageselectCallback(page_index, jq){
    var new_content = jQuery('#hiddenresult div.result ul:eq('+page_index+')').clone();
...
/********************************************End Pagination jquery code start here :: Chandu*****************************************************/