...
/**
* Scenario : To check if default privacy option is set
* Pre-requisite : In backend - Goto rtMedia settings -> Privacy -> PRIVACY SETTINGS -> Default privacy. This option must be selected.
*/
