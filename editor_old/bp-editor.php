...
function kaltura_media_library_form($post_id){
	...
	<div id="media-upload-header">
		<ul id="sidemenu">
			<li><a title="kaltura lib" href="<?php echo BP_MEDIA_PLUGIN_URL ?>/editor/php/bp-editor-ajax.php?filter=mediaall&start=0">All Media</a></li>
			<li><a title="kaltura lib" href="<?php echo BP_MEDIA_PLUGIN_URL ?>/editor/php/bp-editor-ajax.php?filter=photo&start=0">Photos</a></li>
			<li><a title="kaltura lib" href="<?php echo BP_MEDIA_PLUGIN_URL ?>/editor/php/bp-editor-ajax.php?filter=audio&start=0">Audios</a></li>
			<li><a title="kaltura lib" href="<?php echo BP_MEDIA_PLUGIN_URL ?>/editor/php/bp-editor-ajax.php?filter=video&start=0">Videos</a></li>
		</ul>
	</div>	
	<div id="kaltura_lib">
<?php	echo BP_MEDIA_PLUGIN_URL;?>
