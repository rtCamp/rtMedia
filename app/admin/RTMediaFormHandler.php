	...
	static function render_general_content( $options ) {
		$render = array(
			...
			'rtmedia_affiliate_id'  => array(
				...
				'after_content' => esc_html__( 'Signup for', 'buddypress-media' ) . ' rtMedia ' . esc_html__( 'affiliate program', 'buddypress-media' ) . ' <a href="https://rtcamp.com/affiliates">' . esc_html__( 'here', 'buddypress-media' ) . '</a>',
			), //
			'rtmedia_enable_api'    => array(
				...
				'group'         => 80,
				'after_content' => esc_html__( 'You can refer to the API document from', 'buddypress-media' ) . ' <a href="http://docs.rtcamp.com/rtmedia/developers/json-api.html">' . esc_html__( 'here', 'buddypress-media' ) . '</a>',
			), //
		);
