...
if ( ! class_exists( 'RTMediaAdmin' ) ) {
	...
	class RTMediaAdmin {
		...
		/**
		 * Function modify_medialibrary_permalink.
		 *
		...
		/**
		 * Video transcoding survey response.
		 */
