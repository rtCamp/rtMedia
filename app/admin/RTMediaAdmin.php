	...
	class RTMediaAdmin {
				...
				<div class="updated rtmedia-pro-split-notice">
					<p>
						<span>
	                        ...
	                        <a href="https://rtcamp.com/blog/rtmedia-pro-splitting-major-change/?utm_source=dashboard&utm_medium=plugin&utm_campaign=buddypress-media"
				...
				<div class="updated rtmedia-social-sync-notice">
					<p>
						<span>
							...
							<a href="https://rtcamp.com/products/rtmedia-social-sync/?utm_source=dashboard&utm_medium=plugin&utm_campaign=buddypress-media"
							   target="_blank">
		...
		public function rtmedia_inspirebook_release_notice() {
			...
			if ( ( ! $site_option || 'hide' !== $site_option ) && ( 'inspirebook' !== get_stylesheet() ) ) {
				...
				<div class="updated rtmedia-inspire-book-notice">
					<p>
						<span>
							<a href="https://rtcamp.com/products/inspirebook/"
							   target="_blank">
			...
			if ( is_rt_admin() && ( ! $site_option || 'hide' !== $site_option ) ) {
				...
				<div class="error rtmedia-addon-upate-notice">
					<p>
						...
						<a href="https://rtcamp.com/my-account/"
		...
		public function rtmedia_dashboard_widget_function() {
			...
			<div class="rtm-meta-container">
				<ul class="rtm-meta-links">
					...
					<li>
						<a href="https://rtcamp.com/products/category/rtmedia/"><?php esc_html_e( 'Premium Addons', 'buddypress-media' ); ?></a>
					</li>
				</ul>
			</div>
			<?php
			...
			<div class="wrap">
				...
				if ( ! isset( $requested ) ) {
					...
					<p>
						...
						<a href='<?php echo esc_url( 'https://rtcamp.com/rtmedia/docs/admin/addons/audio-video-encoding/' ); ?>' target='_blank'><?php esc_html_e( 'rtMedia audio/video encoding service', 'buddypress-media' ) ?></a>.
					</p>
					<p>
							...
							<div class="bp-media-metabox-holder">
								...
								<div class="rtm-button-container bottom">
									<div class="rtm-social-links alignleft">
										...
										<a href="https://rtcamp.com/feed" class="rss" target="_blank"><span
		...
		public function admin_sidebar() {
			...
			$addons       = '<div id="social" class="rtm-social-share">
							...
							<p><a href="https://www.facebook.com/sharer/sharer.php?u=http://rtcamp.com/rtmedia/" class="button facebook" target="_blank" title="' . esc_attr__( 'Share on Facebook Now', 'buddypress-media' ) . '">' . esc_html__( 'Share on Facebook', 'buddypress-media' ) . '<span class="dashicons dashicons-facebook"></span></a></p>
							...
							<p><a href="' . sprintf( '%s', 'https://rtcamp.com/feed/' ) . '" class="button rss" target="_blank" title="' . esc_attr__( 'Subscribe to our Feeds', 'buddypress-media' ) . '">' . esc_html__( 'Subscribe to our Feeds', 'buddypress-media' ) . '<span class="dashicons dashicons-rss"></span></a></p>
							</div>';
		...
		public function plugin_meta_premium_addon_link( $plugin_meta, $plugin_file ) {
			if ( plugin_basename( RTMEDIA_PATH . 'index.php' ) === $plugin_file ) {
				$plugin_meta[] = '<a href="https://rtcamp.com/rtmedia/addons/?utm_source=dashboard&#038;utm_medium=plugin&#038;utm_campaign=buddypress-media" title="' . esc_attr__( 'Premium Add-ons', 'buddypress-media' ) . '">' . esc_html__( 'Premium Add-ons', 'buddypress-media' ) . '</a>';
			}
