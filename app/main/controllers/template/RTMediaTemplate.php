...
class RTMediaTemplate {
	...
	function json_output() {
		...
		if ( $rtmedia_query->media ) {
			...
			remove_filter( 'rtmedia-model-where-query', 'rtmedia_search_fillter_where_query', 10, 2 );
			remove_filter( 'rtmedia-get-album-where-query', 'rtmedia_search_fillter_where_query', 10, 2 );
			remove_filter( 'rtmedia-get-group-album-where-query', 'rtmedia_search_fillter_where_query', 10, 2 );
