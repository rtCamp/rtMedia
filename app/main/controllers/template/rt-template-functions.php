...
function rtmedia_delete_form ( $echo = true) {
    ...
    if( $echo ){
        ...
        echo '<button type="submit" class="rtmedia-delete-media rtmedia-action-buttons">' . __ ( 'Delete', 'rtmedia' ) . '</button></form>';
    } else {
        $output = $html;
        ...
        do_action("rtmedia_media_single_delete_form");
        $output .= $rtm_nonce_field . '<button type="submit" class="rtmedia-delete-media rtmedia-action-buttons">' . __ ( 'Delete', 'rtmedia' ) . '</button></form>';
        return $output;
    }
