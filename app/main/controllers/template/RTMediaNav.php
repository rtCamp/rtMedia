...
class RTMediaNav {
	...
	public function sub_nav() {
		...
		if ( (
				array_key_exists( 'media_type', $rtmedia_query->query )
				&& isset( $rtmedia_query->query['media_type'] ) && ( 'album' === $rtmedia_query->query['media_type'] )
			)
			|| (
				array_key_exists( 'media_type', $rtmedia_query->action_query )
				&& isset( $rtmedia_query->action_query->media_type )
				&& ( 'album' === $rtmedia_query->action_query->media_type )
			) )
		{
