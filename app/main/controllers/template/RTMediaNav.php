...
//		) );
	...
	static function sub_nav() {
		...
		echo apply_filters( 'rt_media_sub_nav_wall_post' ,
				'<li id="rt-media-nav-item-wall-post-li" ' . $global_album . '><a id="rt-media-nav-item-wall-post" href="' . trailingslashit( get_rt_media_user_link( get_current_user_id() ) ) . 'media/' . RTMediaAlbum::get_default() . '/' . '">' . __("Wall Posts","rt-media") . '</a></li>' );
