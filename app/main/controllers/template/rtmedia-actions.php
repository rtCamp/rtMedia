...
/**
*@Added by : Naveen giri 
*@Description: function to add buddypress language conversion to Media activities 
* it allow language conversion for all activity type "rtmedia_update"
*/
