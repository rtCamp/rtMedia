...
function rtmedia_link_in_footer() {
	...
	if ( $link ) {
		...
		<div class='rtmedia-footer-link'>
			...
			<a href='<?php echo esc_url( 'https://rtmedia.io/?utm_source=dashboard&utm_medium=plugin&utm_campaign=buddypress-media' ); ?>' title='<?php esc_attr_e( 'The only complete media solution for WordPress, BuddyPress and bbPress', 'buddypress-media' ); ?> '>rtMedia</a>
		</div>
		<?php
	}
}
