...
class RTMediaGalleryShortcode {
    ...
    static function register_scripts () {
    	...
    	if(is_rtmedia_album_gallery()) {
    	    $template_url = esc_url( add_query_arg(array("action" => 'rtmedia_get_template', "template" => "album-gallery-item"),admin_url("admin-ajax.php") ) );
        }else{
                $template_url = esc_url( add_query_arg(array("action" => 'rtmedia_get_template', "template" => apply_filters('rtmedia_backbone_template_filter',"media-gallery-item")),admin_url("admin-ajax.php") ) );
        }
