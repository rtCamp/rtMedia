	...
	class RTMediaGroupExtension extends BP_Group_Extension {
		...
		function create_screen( $group_id = null ){
			...
			<div class='rtmedia-group-media-settings'>
				<?php if ( isset( $options['general_enableAlbums'] ) && 1 == $options['general_enableAlbums'] ){ // album is enabled ?>
		...
		<?php global $rtmedia;
			$options = $rtmedia->options;
			if ( isset( $options['general_enableAlbums'] ) && 1 == $options['general_enableAlbums'] ){ // album is enabled
				?>
		...
		function widget_display(){
			...
			<div class="info-group">
				...
				<p>
					<?php _e( 'You could display a small snippet of information from your group extension here. It will show on the group home screen.', 'rtmedia' ); ?>
				</p>
			</div>
		<?php
		}
