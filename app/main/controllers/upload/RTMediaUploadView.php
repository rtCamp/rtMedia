		...
		$tabs = array(
			'file_upload' => array(
				'default' => array( 'title' => __( 'File Upload', 'rtmedia' ),
					...
					. '</div>' ),
				'activity' => array( 'title' => __( 'File Upload', 'rtmedia' ), 'content' => '<div class="rtmedia-plupload-container"><div id="rtmedia-action-update" class="clearfix"><div class="rtm-upload-button-wrapper"><div id="rtmedia-whts-new-upload-container"></div><button type="button" class="rtmedia-add-media-button" id="rtmedia-add-media-button-post-update"><span class="dashicons dashicons-admin-media"></span>' . apply_filters( 'rtmedia_attach_file_message', __( '', 'rtmedia' ) ) . '</button></div>' . $up_privacy . '</div></div><div class="rtmedia-plupload-notice"><ul class="plupload_filelist_content ui-sortable" id="rtmedia_uploader_filelist"></ul></div>' )
			),
