	...
	$album = '';
        ...
        $tabs = array(
            'file_upload' => array(
				...
				'activity' => array( 'title' => __( 'File Upload', 'rtmedia' ), 'content' => '<div class="rtmedia-plupload-container"><div id="rtmedia-action-update"><button type="button" class="rtmedia-add-media-button" id="rtmedia-add-media-button-post-update"><i class="rtmicon-plus-circle rtmicon-fw"></i>' . apply_filters('rtmedia_attach_file_message', __( 'Attach Files', 'rtmedia' ) ) . '</button>' . $up_privacy . '</div><div id="rtmedia-whts-new-upload-container"></div></div><div class="rtmedia-plupload-notice"><div id="rtm-upload-start-notice"><span>'. apply_filters('rtmedia_post_update_click_message', __( 'Upload will start only after you enter content and click Post Update.', 'rtmedia' ) ). '</span></div><table id="rtMedia-queue-list" class="rtMedia-queue-list"><tbody></tbody></table></div>')
            ),
