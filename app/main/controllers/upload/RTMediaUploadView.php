        ...
        $tabs = array(
            'file_upload' => array(
                'default' => array( 'title' => __( 'File Upload', 'rtmedia' ),
                    ...
                    . '<table id="rtMedia-queue-list" class="rtMedia-queue-list" style="width:100%;"><tbody></tbody></table></div>'
                    . '</div>' ),
