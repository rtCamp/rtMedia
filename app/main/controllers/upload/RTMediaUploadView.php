        ...
        $tabs = array(
            'file_upload' => array(
                'default' => array( 'title' => __( 'File Upload', 'rtmedia' ),
                    ...
                    . '<ul class="plupload_filelist_content ui-sortable" id="rtmedia_uploader_filelist"></ul></div>'
                    . '</div>' ),
