	...
	$album = '';
        ...
        $tabs = array(
            'file_upload' => array(
                'default' => array( 'title' => __( 'File Upload', 'rtmedia' ),
                    ...
                    '<div id="rtmedia-upload-container" >'
                        . '<div id="drag-drop-area" class="drag-drop row">'
                                ...
                                . '<span class="rtm-seperator">' . __('or','rtmedia') .'</span><span class="drag-drop-info">' . __('Drop your files here', 'rtmedia') . '</span> <i class="rtm-file-size-limit dashicons dashicons-info rtmicon"></i></div>'
                    ...
                    . '<table id="rtMedia-queue-list" class="rtMedia-queue-list"><tbody></tbody></table><ul class="plupload_filelist_content ui-sortable" id="rtmedia_uploader_filelist"></ul></div>'
                    . '</div>' ),
				...
				'activity' => array( 'title' => __( 'File Upload', 'rtmedia' ), 'content' => '<div class="rtmedia-plupload-container"><div id="rtmedia-action-update"><div class="rtm-upload-button-wrapper"><div id="rtmedia-whts-new-upload-container"></div><button type="button" class="rtmedia-add-media-button" id="rtmedia-add-media-button-post-update"><i class="dashicons dashicons-plus-alt rtmicon"></i>' . apply_filters('rtmedia_attach_file_message', __( 'Attach Files', 'rtmedia' ) ) . '</button></div>' . $up_privacy . '</div></div><div class="rtmedia-plupload-notice"><table id="rtMedia-queue-list" class="rtMedia-queue-list"><tbody></tbody></table><ul class="plupload_filelist_content ui-sortable" id="rtmedia_uploader_filelist"></ul></div>')
            ),
