...
class RTMediaQuery {
	...
	public function &query( $query ) {
		...
		if ( ! empty( $rtmedia_shortcode ) ) {
			$query_data = $_REQUEST; // phpcs:ignore WordPress.Security.NonceVerification.Recommended, phpcs:ignore WordPress.Security.NonceVerification.NoNonceVerification -- We are just replacing the args so nonce verification is not needed.
	...
	public function permalink() {
		...
		return trailingslashit( $parent_link . RTMEDIA_MEDIA_SLUG . $rtmedia_media->id );
	}
