...
class RTMediaQuery {
	...
	function &query( $query ) {
		...
		//Set Json
		$allowed_query = apply_filters( 'rtmedia_allowed_query', array( "id", "media_id", "media_type", "media_author", "album_id", "context", "context_id", "global", "privacy", "per_page", "lightbox" ) );
