...
class BPMediaAlbum{
	...
	function get_album_gallery_content(){
		?><li>
			...
			<h3 title="<?php echo $this->name ?>"><a href="<?php echo $this->url ?>" title="<?php _e($this->description,BP_MEDIA_TXT_DOMAIN); ?>"><?php echo ( ( strlen( $this->name ) > 16 ) ? substr( $this->name, 0, 16 ) . "&hellip;" : $this->name );?></a><?php echo ' ('.count($this->media_entries).')'; ?></h3>
		</li><?php
	}
