...
if ( ! class_exists( 'RTMediaAddon' ) ) {
	...
	class RTMediaAddon {
		...
		public function get_addons() {
			...
			$tabs[] = array(
				'title' =>  esc_attr__( 'Plugins', 'buddypress-media' ),
			...
			$tabs[] = array(
				'title' =>  esc_attr__( 'Audio/Video  Encoding', 'buddypress-media' ),
		...
		public function plugins_content( $args = '' ) {
			...
			$addons = array(
				array(
					'title' =>  esc_attr__( 'SEO', 'buddypress-media' ),
					...
					'title' =>  esc_attr__( 'Moderation', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Custom Attributes', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Docs and Other files', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Default Albums', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Podcast (RSS and Atom feeds)', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Playlists', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Favorites', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Restrictions', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'bbPress Attachments', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'WordPress Sitewide Gallery', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'WordPress Comment Attachments', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Social Sharing', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Sidebar Widgets', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( '5 Star Ratings', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Edit Mp3 Info (ID3 Tags)', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Media Sorting', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Bulk Edit', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'BuddyPress Profile Picture', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Album Cover Art', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Direct Download Link', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Upload by URL', 'buddypress-media' ),
				...
				array(
					'title' => esc_attr__( 'Media Likes', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Activity URL Preview', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'View Counter', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Shortcode Generator', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Album Privacy', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'BuddyPress Group Media Control', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Set Custom Thumbnail for Audio/Video', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'myCRED', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Upload terms', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'CubePoints', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Social Sync', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Photo Watermark', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Photo Tagging', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Photo Filters', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Kaltura Add-on', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'FFMPEG Add-on', 'buddypress-media' ),
				...
				array(
					'title' =>  esc_attr__( 'Membership Add-on', 'buddypress-media' ),
