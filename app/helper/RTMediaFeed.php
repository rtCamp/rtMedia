	...
	public function fetch_feed() {
		...
		if ( 0 == $maxitems ) {
			...
			foreach ( $rss_items as $item ) {
				?>
			    <li>
                                <a href='<?php echo $item->get_permalink(); ?>?utm_source=dashboard&utm_medium=plugin&utm_campaign=buddypress-media' title='<?php echo esc_attr__( 'Posted ', 'buddypress-media' ) . $item->get_date( 'j F Y | g:i a' ); ?>'><?php echo $item->get_title(); ?></a>
			    </li><?php
			}
		}
		?>
