				...
				if ( 1 !== $bp_album_active ) {
					echo '<div id="setting-error-bp-album-importer" class="error settings-error below-h2">
						<p><strong>' . esc_html__( 'Warning!', 'buddypress-media' ) . '</strong> ' .
					     ...
					     '<a target="_blank" href="http://rtcamp.com/contact/?purpose=buddypress&utm_source=dashboard&utm_medium=plugin&utm_campaign=buddypress-media">' . esc_html__( 'hiring us', 'buddypress-media' ) . '</a>' .
