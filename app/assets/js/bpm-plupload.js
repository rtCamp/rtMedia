...
jQuery(document).ready(function(){
    ...
    var in_list = 0;
    if(jQuery('#'+bpm_plupload_params.container).length==0)
        return false;
    ...
    jQuery('#btn-create-new').click(function(){
        ...
        if(new_album_name.length==0){
            ...
            var data = {
                ...
                bp_media_group_id : bpm_plupload_params.multipart_params.bp_media_group_id
            };
    ...
    var bp_media_uploader=new plupload.Uploader(bpm_plupload_params);
