<?php
/**
 * Shows media gallery items list.
 *
 * @package rtMedia
 */
...
<li class="rtmedia-list-item" id="<?php echo rtmedia_id(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>" data-media_type="<?php echo esc_attr( rtmedia_type( rtmedia_id() ) ); ?>">
