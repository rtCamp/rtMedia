	...
	<?php if ( rtmedia_is_global_album( $rtmedia_query->media_query[ 'album_id' ] ) ) { ?>
		...
		<div class="rtmedia-edit-media-tabs rtmedia-editor-main">
			<ul class="rtm-tabs clearfix">
				<li class="active"><a href="#details-tab"><i class='dashicons dashicons-edit rtmicon'></i><?php esc_html_e( 'Details', 'buddypress-media' ); ?></a></li>
				<?php if ( ! is_rtmedia_group_album() ) { ?>
					<li class=""><a href="#manage-media-tab"><i class='dashicons dashicons-list-view rtmicon'></i><?php esc_html_e( 'Manage Media', 'buddypress-media' ); ?></a></li>
				<?php } ?>
			...
			<div class="rtm-tabs-content">
				<div class="content active" id="details-tab">
					<form method="post" class="rtm-form">
						...
						<div>
							<input type="submit" name="submit" class='rtmedia-save-album' value="<?php esc_html_e( 'Save Changes', 'buddypress-media' ); ?>" />
						...
						<?php if ( have_rtmedia() ) { ?>
							<form class="rtmedia-album-edit rtmedia-bulk-actions" method="post" name="rtmedia_album_edit">
								...
								<p class="rtmedia-move-container">
									...
									<input type="button" class="rtmedia-move-selected" name="move-selected" value="<?php esc_html_e( 'Move Selected', 'buddypress-media' ); ?>" />
								</p>
								...
								?>
								<a id="rtMedia-galary-prev" <?php echo $display; ?> href="<?php echo rtmedia_pagination_prev_link(); ?>"><?php esc_html_e( 'Prev', 'buddypress-media' ); ?></a>
								...
								if ( rtmedia_offset() + rtmedia_per_page_media() < rtmedia_count() )
									...
									$display = 'style="display:none;"';
								?>
								<a id="rtMedia-galary-next" <?php echo $display; ?> href="<?php echo rtmedia_pagination_next_link(); ?>"><?php esc_html_e( 'Next', 'buddypress-media' ); ?></a>
							</form>
						<?php } else { ?>
